package kassuk.addon.blackout.utils.th;
...
public final class ThSoundPack {
    public static final Identifier KEYPRESS_SOUND = new Identifier("kassuk.addon.blackout:keypress");
    public static SoundEvent KEYPRESS_SOUNDEVENT = SoundEvent.of(KEYPRESS_SOUND);
    public static final Identifier KEYRELEASE_SOUND = new Identifier("kassuk.addon.blackout:keyrelease");
    public static SoundEvent KEYRELEASE_SOUNDEVENT = SoundEvent.of(KEYRELEASE_SOUND);
    public static final Identifier UWU_SOUND = new Identifier("kassuk.addon.blackout:uwu");
    public static SoundEvent UWU_SOUNDEVENT = SoundEvent.of(UWU_SOUND);
    public static final Identifier ENABLE_SOUND = new Identifier("kassuk.addon.blackout:enable");
    public static SoundEvent ENABLE_SOUNDEVENT = SoundEvent.of(ENABLE_SOUND);
    public static final Identifier DISABLE_SOUND = new Identifier("kassuk.addon.blackout:disable");
    public static SoundEvent DISABLE_SOUNDEVENT = SoundEvent.of(DISABLE_SOUND);
    public static final Identifier MOAN1_SOUND = new Identifier("kassuk.addon.blackout:moan1");
    public static SoundEvent MOAN1_SOUNDEVENT = SoundEvent.of(MOAN1_SOUND);
    public static final Identifier MOAN2_SOUND = new Identifier("kassuk.addon.blackout:moan2");
    public static SoundEvent MOAN2_SOUNDEVENT = SoundEvent.of(MOAN2_SOUND);
    public static final Identifier MOAN3_SOUND = new Identifier("kassuk.addon.blackout:moan3");
    public static SoundEvent MOAN3_SOUNDEVENT = SoundEvent.of(MOAN3_SOUND);
    public static final Identifier MOAN4_SOUND = new Identifier("kassuk.addon.blackout:moan4");
    public static SoundEvent MOAN4_SOUNDEVENT = SoundEvent.of(MOAN4_SOUND);
    public static final Identifier MOAN5_SOUND = new Identifier("kassuk.addon.blackout:moan5");
    public static SoundEvent MOAN5_SOUNDEVENT = SoundEvent.of(MOAN5_SOUND);
    public static final Identifier SKEET_SOUND = new Identifier("kassuk.addon.blackout:skeet");
    public static SoundEvent SKEET_SOUNDEVENT = SoundEvent.of(SKEET_SOUND);
    public static final Identifier ORTHODOX_SOUND = new Identifier("kassuk.addon.blackout:orthodox");
