package kassuk.addon.blackout.hud.ayo;
...
import kassuk.addon.blackout.utils.ayo.Source;
...
public class ImageHUD extends HudElement {
    public static final HudElementInfo<ImageHUD> INFO = new HudElementInfo<>(BlackOut.HUD_BLACKOUT, "e621-image", "sex", ImageHUD::create);
