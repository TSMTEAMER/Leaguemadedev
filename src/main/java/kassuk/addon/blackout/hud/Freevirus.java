...
public class Freevirus extends HudElement {
    ...
    public static final HudElementInfo<Freevirus> INFO = new HudElementInfo<>(BlackOut.HUD_BLACKOUT, "Freevirus", "I don't even know what this is.", Freevirus::new);
