...
public class BlackoutArray extends HudElement {
    ...
    public static final HudElementInfo<BlackoutArray> INFO = new HudElementInfo<>(BlackOut.HUD_BLACKOUT, "array", "An ArrayList for blackout features.", BlackoutArray::new);
    ...
    private List<Module> getModules() {
        return Modules.get().getActive()
            .stream()
            .filter(module -> !onlyBlackout.get() || module.category.equals(BlackOut.HUD_BLACKOUT))
            .collect(Collectors.toList());
    }
