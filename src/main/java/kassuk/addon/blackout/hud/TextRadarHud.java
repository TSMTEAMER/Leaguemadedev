...
public class TextRadarHud extends HudElement {
    public static final HudElementInfo<TextRadarHud> INFO = new HudElementInfo<>(BlackOut.HUD_BLACKOUT, "text-radar", "Displays players and their stats in your visual range.", TextRadarHud::new);
