...
import kassuk.addon.blackout.utils.spotify.SpotifyService;
...
public class SpotifyHud extends HudElement {
    public static final HudElementInfo<SpotifyHud> INFO = new HudElementInfo<>(BlackOut.HUD_BLACKOUT, "spotify-hud", "Display the current song playing in spotify.", SpotifyHud::new);
    ...
    public void tick(HudRenderer renderer) {
        ...
        } else if (SpotifyService.currentTrack == null) {
            t = "Idle";
        } else {
            t = "Playing " + SpotifyUtils.spotifyTrack() + " - " + SpotifyUtils.spotifyArtist();
        }
