...
public class BindsHud extends HudElement {
    public static final HudElementInfo<BindsHud> INFO = new HudElementInfo<>(BlackOut.HUD_BLACKOUT, "binds-hud", "Displays modules you've binded keys to.", BindsHud::new);
