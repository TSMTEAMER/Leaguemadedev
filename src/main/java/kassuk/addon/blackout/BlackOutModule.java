...
public class BlackOutModule extends Module {
    private final String prefix = Formatting.DARK_PURPLE + "[League]";
    public int priority;
    ...
    public void sendToggledMsg() {
        if (Config.get().chatFeedback.get() && chatFeedback && mc.world != null) {
            ...
            String msg = prefix + " " + Formatting.WHITE + name + (isActive() ? Formatting.GREEN + " [+]" : Formatting.RED + " [-]");
    ...
    public void sendToggledMsg(String message) {
        if (Config.get().chatFeedback.get() && chatFeedback && mc.world != null) {
            ChatUtils.forceNextPrefixClass(getClass());
            String msg = prefix + " " + Formatting.WHITE + name + (isActive() ? Formatting.GREEN + " [+] " : Formatting.RED + " [-] ") + Formatting.GRAY + message;
            sendMessage(Text.of(msg), hashCode());
        }
    }
