...
import kassuk.addon.blackout.modules.combat.SelfTrapPlus;
import kassuk.addon.blackout.modules.combat.SurroundPlus;
...
public class AutoMend extends BlackOutModule {
    public AutoMend() {
        super(BlackOut.MISCPLUS, "Auto Mend", "Automatically mends your armor with experience bottles.");
    }
