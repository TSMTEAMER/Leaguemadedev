...
import kassuk.addon.blackout.modules.combat.BedAura;
import meteordevelopment.meteorclient.events.world.TickEvent;
import kassuk.addon.blackout.modules.combat.XPThrower;
...
public class Sevila extends Module {
    ...
    public Sevila() {
        super(BlackOut.MISCPLUS, "Sevila", "Rotates around and got some players mad.");
    }
