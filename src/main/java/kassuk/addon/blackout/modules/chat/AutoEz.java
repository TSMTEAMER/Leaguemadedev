...
public class AutoEz extends BlackOutModule {
    public AutoEz() {
        super(BlackOut.CHATPLUS, "Auto EZ", "Sends message after enemy dies (too EZ nn's).");
    }
    ...
    private final String[] MoseyWare = new String[]{
        "<AutoEz> %s you just got pwned by MoseyWare ",
        "<AutoEz> %s ez owned by MoseyWare ",
        "<AutoEz> to ez %s u got ezed by MoseyWare ",
        "<AutoEz> %s eat dirt",
        "<AutoEz> %s you focking suck",
        "<AutoEz> %s MoseyWare was made by me i think",
        "<AutoEz> %s MoseyWare on tope",
        "<AutoEz> %s MoseyWare on tep",
        "<AutoEz> %s can a nigga borrow a french fries",
        "<AutoEz> just made a nigga wet ask %s"

    };
    private final String[] League = new String[]{
        "%s Just died to league",
        "%s died to league by being cringe and ugly",
        "%s nigga died to league",
        "%s fucking shitter ahhh",
        "%s instead of dying how bout u get league",
        "%s clipped going on league tage",
        "%s why u dying to league?",
        "sit %s, league owns u",
        "just made %s die using league",
        "%s fanjuice",
        "killed %s usin league",
        "smoking %s pack with league",
        "just killed %s with the power of league",
        "%s ezjuice only possible with league",
    };
