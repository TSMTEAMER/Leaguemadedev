...
import kassuk.addon.blackout.utils.random.Emotes;
...
public class ChatTweaks extends Module {
    ...
    public final Setting<Boolean> emotes = sgGeneral.add(new BoolSetting.Builder().name("emotes").description("Enables the Leagye emote system.").defaultValue(false).build());
    ...
    public final Setting<String> prefixText = sgGeneral.add(new StringSetting.Builder().name("custom-prefix-text").description("Override the [League] prefix.").defaultValue("League").visible(customPrefix :: get).build());
    ...
    public ChatTweaks() {
        super(BlackOut.CHATPLUS, "better-chat-plus", "Various chat improvements.");
    }
    ...
    public void onActivate() {
        ChatUtils.registerCustomPrefix("kassuk.addon.blackout", this::getPrefix);
    }
