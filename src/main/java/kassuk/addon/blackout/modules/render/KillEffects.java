...
import kassuk.addon.blackout.utils.bana.BWorldUtils;
...
import static kassuk.addon.blackout.utils.bana.BEntityUtils.deadEntity;
import static kassuk.addon.blackout.utils.bana.BEntityUtils.isDeathPacket;
public class KillEffects extends Module {
    ...
    public KillEffects() {
        super(BlackOut.RENDERPLUS, "kill-effects", "Spawns a lightning where a player dies.");
    }
