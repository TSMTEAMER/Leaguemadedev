...
import kassuk.addon.blackout.utils.orion.BlockHelper;
import kassuk.addon.blackout.utils.orion.AutomationUtils;
import kassuk.addon.blackout.utils.orion.ItemHelper;
...
public class AutoCityPlus extends Module {
    ...
    public AutoCityPlus() {
        super(BlackOut.COMBATPLUS, "auto-city-plus", "Auto city but better.");
    }
