...
import kassuk.addon.blackout.modules.misc.Suicide;
...
public class AutoCrystal extends BlackOutModule {
    public AutoCrystal() {
        super(BlackOut.COMBATPLUS, "Auto Crystal", "Breaks and places crystals automatically (but better).");
    }
