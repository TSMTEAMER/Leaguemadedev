...
public class BedAura extends BlackOutModule {
    public BedAura() {
        super(BlackOut.COMBATPLUS, "Bed Aura", "Automatically places and breaks beds to cause damage to your opponents but better.");
    }
