...
package kassuk.addon.blackout.modules.movement;
...
import kassuk.addon.blackout.BlackOut;
import kassuk.addon.blackout.utils.trouser.OffGroundSpeedEvent;
...
public class TPFly extends Module {
    ...
    public TPFly() {
        super(BlackOut.MOVEMENTPLUS, "TPFly", "Teleports you to flyyyyyyyyy!");
    }
